...
private:
  ...
  virtual void draw(sf::RenderTarget& target, sf::RenderStates states) const; ///< rysujaca tlo (z biblioteki SFML)
  void setQuadPositions(sf::Vertex* quad, int col, int row);                  ///< wyznaczca pozycje kafelki na mapie
  void setQuadCoords(sf::Vertex* quad, int col, int row, int tileType);       ///< wyznaczajaca pozycje kafelki w pliku graficznym
